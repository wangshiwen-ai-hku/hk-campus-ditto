...
export const copy: Dict = {
  brand: { en: "DopaMine", "zh-HK": "DopaMine", "zh-CN": "DopaMine" },
  ...
  how3: { en: "Confirm the match", "zh-HK": "確認配對", "zh-CN": "确认匹配" },
  how3b: { en: "If both sides are interested, Dopa shares contact details and leaves timing to you.", "zh-HK": "如果雙方都有興趣，Dopa 會分享聯絡方式，時間由您哋自己安排。", "zh-CN": "如果双方都有兴趣，Dopa 会分享联系方式，时间交给您们自己安排。" },
