...
function labelSet(locale: Locale) {
  if (locale === "zh-HK") {
    return {
      ...
      sharedSubject: "雙方都 Confirm 咗，聯絡方式可以分享啦",
      contactIntro: "好消息，您同對方都 Confirm 咗。以下係對方願意分享嘅聯絡方式。",
      dateIdeas: "約會地點建議",
      gifts: "小禮物靈感",
      tips: "第一次見面 Tips",
      whatsapp: "WhatsApp",
  ...
  if (locale === "zh-CN") {
    return {
      ...
      sharedSubject: "双方都 Confirm 了，可以分享联系方式了",
      contactIntro: "好消息，您和对方都 Confirm 了。以下是对方愿意分享的联系方式。",
      dateIdeas: "约会地点建议",
      gifts: "小礼物灵感",
      tips: "第一次见面 Tips",
      whatsapp: "WhatsApp",
  ...
  return {
    ...
    sharedSubject: "You both confirmed — contact details are ready",
    contactIntro:
      "Great news: you both confirmed. Here are the contact details your match agreed to share.",
